...
Karavi Topology follows a scaled trunk branching strategy where short-lived branches are created off of the main branch. When coding is complete, the branch is merged back into main after being approved in a pull request code review.
...
5. Open a [pull request](https://github.com/dell/karavi-topology/pulls) between your branch and the upstream main branch.
